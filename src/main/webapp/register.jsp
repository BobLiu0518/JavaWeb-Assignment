...
<div class="container">
    ...
    <div class="card auth">
        <h2>注册</h2>
        <form class="form" method="post" action="<c:url value="/auth/register"/>">
            <div class="form-row">
            ...
            <div class="form-row">
                ...
                <div class="captcha-input">
                    ...
                    <img class="captchaImg" id="captchaImg" src="<c:url value="/captcha"/>"/>
                </div>
            </div>
            <div class="actions">
                <button class="btn btn-primary" type="submit">注册</button>
                <a class="footer-link" href="<c:url value="/login.jsp"/>">已有账号？去登录</a>
            </div>
        </form>
    </div>
</div>
